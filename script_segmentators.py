from skimage import segmentation, io, morphology, measure, color
from skimage.segmentation import felzenszwalb, watershed, random_walker, relabel_sequential
...
def apply_k_means(img):
    seg = segmentation.slic(gaussian(img, 5), n_segments=8, compactness=10)
